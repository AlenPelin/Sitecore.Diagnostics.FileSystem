namespace Sitecore.Diagnostics.FileSystem.TestingHelpers.Tests
{
    ...
    public class MockFileMoveTests {
        ...
        public void MockFile_Move_ShouldMoveFileWithinMemoryFileSystem()
        {
            ...
            fileSystem.Internals.File.Move(sourceFilePath, destFilePath);
        ...
        public void MockFile_Move_ShouldThrowIOExceptionWhenTargetAlreadyExists()
        {
            ...
            var exception = Assert.Throws<IOException>(() => fileSystem.Internals.File.Move(sourceFilePath, destFilePath));
        ...
        public void MockFile_Move_ShouldThrowArgumentNullExceptionWhenSourceIsNull_Message()
        {
            ...
            var exception = Assert.Throws<ArgumentNullException>(() => fileSystem.Internals.File.Move(null, destFilePath));
        ...
        public void MockFile_Move_ShouldThrowArgumentExceptionWhenSourceIsEmpty_Message()
        {
            ...
            var exception = Assert.Throws<ArgumentException>(() => fileSystem.Internals.File.Move(string.Empty, destFilePath));
        ...
        public void MockFile_Move_ShouldThrowArgumentExceptionWhenSourceIsStringOfBlanks()
        {
            ...
            var exception = Assert.Throws<ArgumentException>(() => fileSystem.Internals.File.Move(sourceFilePath, destFilePath));
        ...
        public void MockFile_Move_ShouldThrowArgumentNullExceptionWhenTargetIsNull_Message()
        {
            ...
            var exception = Assert.Throws<ArgumentNullException>(() => fileSystem.Internals.File.Move(sourceFilePath, null));
        ...
        public void MockFile_Move_ShouldThrowArgumentExceptionWhenTargetIsEmpty_Message()
        {
            ...
            var exception = Assert.Throws<ArgumentException>(() => fileSystem.Internals.File.Move(sourceFilePath, string.Empty));
        ...
        public void MockFile_Move_ShouldThrowFileNotFoundExceptionWhenSourceDoesNotExist_Message()
        {
            ...
            var exception = Assert.Throws<FileNotFoundException>(() => fileSystem.Internals.File.Move(sourceFilePath, destFilePath));
        ...
        public void MockFile_Move_ShouldThrowDirectoryNotFoundExceptionWhenSourcePathDoesNotExist_Message()
        {
            ...
            Assert.That(() => fileSystem.Internals.File.Move(sourceFilePath, destFilePath),
