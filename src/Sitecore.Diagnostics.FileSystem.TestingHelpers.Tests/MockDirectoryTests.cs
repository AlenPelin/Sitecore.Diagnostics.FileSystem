...
namespace Sitecore.Diagnostics.FileSystem.TestingHelpers.Tests
{
    ...
    public class MockDirectoryTests
    {
        ...
        public void MockDirectory_GetFiles_ShouldReturnAllFilesBelowPathWhenPatternIsWildcardAndSearchOptionIsAllDirectories()
        {
            ...
            // Act
            var result = fileSystem.Internals.Directory.GetFiles(XFS.Path(@"c:\a"), "*", SearchOption.AllDirectories);
        ...
        public void MockDirectory_GetFiles_ShouldReturnFilesDirectlyBelowPathWhenPatternIsWildcardAndSearchOptionIsTopDirectoryOnly()
        {
            ...
            // Act
            var result = fileSystem.Internals.Directory.GetFiles(XFS.Path(@"c:\a"), "*", SearchOption.TopDirectoryOnly);
        ...
        public void MockDirectory_GetFiles_FilterShouldFindFilesWithSpecialChars()
        {
            ...
            // Act
            var result = fileSystem.Internals.Directory.GetFiles(XFS.Path(@"c:\"), "*.*", SearchOption.AllDirectories);
        ...
        public void MockDirectory_Exists_ShouldReturnTrueForDirectoryDefinedInMemoryFileSystemWithoutTrailingSlash()
        {
            ...
            // Act
            var result = fileSystem.Internals.Directory.Exists(XFS.Path(@"c:\foo"));
        ...
        public void MockDirectory_Exists_ShouldReturnFalseForDirectoryNotDefinedInMemoryFileSystemWithoutTrailingSlash()
        {
            ...
            // Act
            var result = fileSystem.Internals.Directory.Exists(XFS.Path(@"c:\baz"));
        ...
        public void MockDirectory_Exists_ShouldReturnTrueForDirectoryCreatedViaMocks()
        {
            ...
            // Act
            var result = fileSystem.Internals.Directory.Exists(XFS.Path(@"c:\bar"));
        ...
        public void MockDirectory_Exists_ShouldReturnFalseForIllegalPath(string path)
        {
            ...
            // Act
            var result = fileSystem.Internals.Directory.Exists(path);
        ...
        public void MockDirectory_Exists_ShouldReturnFalseForFiles()
        {
            ...
            // Act
            var result = fileSystem.Internals.Directory.Exists(XFS.Path(@"c:\foo\bar.txt"));
        ...
        public void MockDirectory_CreateDirectory_ShouldIgnoreExistingDirectoryRegardlessOfTrailingSlash()
        {
            ...
            // Act/Assert
            Assert.That(() => fileSystem.Internals.Directory.CreateDirectory(XFS.Path(@"c:\foo")), Throws.Nothing);
            Assert.That(() => fileSystem.Internals.Directory.CreateDirectory(XFS.Path(@"c:\foo\")), Throws.Nothing);
        }
        ...
        public void MockDirectory_CreateDirectory_ShouldReturnDirectoryInfoBase()
        {
            ...
            // Act
            var result = fileSystem.Internals.Directory.CreateDirectory(XFS.Path(@"c:\bar"));
        ...
        public void MockDirectory_CreMockDirectory_CreateDirectory_ShouldReturnDirectoryInfoBaseWhenDirectoryExists()
        {
            ...
            // Act
            var result = fileSystem.Internals.Directory.CreateDirectory(XFS.Path(@"c:\foo\"));
        ...
        public void MockDirectory_CreateDirectory_ShouldWorkWithUNCPath()
        {
            ...
            // Act
            fileSystem.Internals.Directory.CreateDirectory(XFS.Path(@"\\server\share\path\to\create", () => false));

            // Assert
            Assert.IsTrue(fileSystem.Internals.Directory.Exists(XFS.Path(@"\\server\share\path\to\create\", () => false)));
        }
        ...
        public void MockDirectory_CreateDirectory_ShouldFailIfTryingToCreateUNCPathOnlyServer()
        {
            ...
            // Act
            var ex = Assert.Throws<ArgumentException>(() => fileSystem.Internals.Directory.CreateDirectory(XFS.Path(@"\\server", () => false)));
        ...
        public void MockDirectory_CreateDirectory_ShouldSucceedIfTryingToCreateUNCPathShare()
        {
            ...
            // Act
            fileSystem.Internals.Directory.CreateDirectory(XFS.Path(@"\\server\share", () => false));

            // Assert
            Assert.IsTrue(fileSystem.Internals.Directory.Exists(XFS.Path(@"\\server\share\", () => false)));
        }
        ...
        public void MockDirectory_Delete_ShouldDeleteDirectory()
        {
            ...
            // Act
            fileSystem.Internals.Directory.Delete(XFS.Path(@"c:\bar"), true);

            // Assert
            Assert.IsFalse(fileSystem.Internals.Directory.Exists(XFS.Path(@"c:\bar")));
        }
        ...
        public void MockDirectory_Delete_ShouldDeleteDirectoryRecursively()
        {
            ...
            // Assert
            Assert.IsFalse(fileSystem.Internals.Directory.Exists(XFS.Path(@"c:\bar")));
            Assert.IsFalse(fileSystem.Internals.Directory.Exists(XFS.Path(@"c:\bar\bar2")));
        }
        ...
        public void MockDirectory_GetFiles_ShouldThrowArgumentNullException_IfPathParamIsNull()
        {
            ...
            TestDelegate action = () => fileSystem.Internals.Directory.GetFiles(null);
        ...
        public void MockDirectory_GetFiles_ShouldThrowDirectoryNotFoundException_IfPathDoesNotExists()
        {
            ...
            // Act
            TestDelegate action = () => fileSystem.Internals.Directory.GetFiles(XFS.Path(@"c:\Foo"), "*a.txt");
        ...
        public void MockDirectory_GetFiles_ShouldThrowAnArgumentNullException_IfSearchPatternIsNull()
        {
            ...
            // Act
            TestDelegate action = () => fileSystem.Internals.Directory.GetFiles(directoryPath, null);
        ...
        public void MockDirectory_GetFiles_ShouldThrowAnArgumentException_IfSearchPatternEndsWithTwoDots()
        {
            ...
            // Act
            TestDelegate action = () => fileSystem.Internals.Directory.GetFiles(directoryPath, "*a..");
        ...
        public void MockDirectory_GetFiles_ShouldThrowAnArgumentException_IfSearchPatternContainsTwoDotsFollowedByOneDirectoryPathSep(string searchPattern)
        {
            ...
            // Act
            TestDelegate action = () => fileSystem.Internals.Directory.GetFiles(directoryPath, searchPattern);
        ...
        public void MockDirectory_GetDirectories_ShouldThrowWhenPathIsNotMocked()
        {
            ...
            // Act
            TestDelegate action = () => fileSystem.Internals.Directory.GetDirectories(XFS.Path(@"c:\d"));
        ...
        public void MockDirectory_EnumerateDirectories_ShouldThrowWhenPathIsNotMocked()
        {
            ...
            // Act
            TestDelegate action = () => fileSystem.Internals.Directory.EnumerateDirectories(XFS.Path(@"c:\d"));
        ...
        public void Move_DirectoryExistsWithDifferentCase_DirectorySuccessfullyMoved()
        {
            ...
            // Act
            fileSystem.Internals.Directory.Move(@"C:\old_location", @"C:\NewLocation\");

            // Assert
            Assert.IsTrue(fileSystem.Internals.File.Exists(@"C:\NewLocation\Data\someFile.txt"));
        }
        ...
        public void MockDirectory_Move_ShouldMove(string sourceDirName, string destDirName, string filePathOne, string filePathTwo)
        {
            ...
            // Assert
            Assert.IsFalse(fileSystem.Internals.Directory.Exists(sourceDirName));
            Assert.IsTrue(fileSystem.Internals.File.Exists(XFS.Path(destDirName + filePathOne)));
            Assert.IsTrue(fileSystem.Internals.File.Exists(XFS.Path(destDirName + filePathTwo)));
        }
        ...
        public void MockDirectory_GetCurrentDirectory_ShouldReturnValueFromFileSystemConstructor() {
            ...
            var actual = fileSystem.Internals.Directory.GetCurrentDirectory();
        ...
        public void MockDirectory_SetCurrentDirectory_ShouldChangeCurrentDirectory() {
            ...
            // Precondition
            Assert.AreNotEqual(directory, fileSystem.Internals.Directory.GetCurrentDirectory());

            fileSystem.Internals.Directory.SetCurrentDirectory(directory);

            Assert.AreEqual(directory, fileSystem.Internals.Directory.GetCurrentDirectory());
        }
        ...
        public void MockDirectory_GetParent_ShouldThrowArgumentNullExceptionIfPathIsNull()
        {
            ...
            // Act
            TestDelegate act = () => fileSystem.Internals.Directory.GetParent(null);
        ...
        public void MockDirectory_GetParent_ShouldThrowArgumentExceptionIfPathIsEmpty()
        {
            ...
            // Act
            TestDelegate act = () => fileSystem.Internals.Directory.GetParent(string.Empty);
        ...
        public void MockDirectory_GetParent_ShouldThrowArgumentExceptionIfPathHasIllegalCharacters()
        {
            ...
            // Act
            TestDelegate act = () => fileSystem.Internals.Directory.GetParent(XFS.Path("c:\\director\ty\\has\\illegal\\character"));
        ...
        public void MockDirectory_GetParent_ShouldReturnNullIfPathIsRoot()
        {
            ...
            // Act
            var actualResult = fileSystem.Internals.Directory.GetParent(XFS.Path(@"c:\"));
        ...
        public void MockDirectory_GetParent_ShouldReturnTheParentWithoutTrailingDirectorySeparatorChar(string path, string expectedResult)
        {
            ...
            // Act
            var actualResult = fileSystem.Internals.Directory.GetParent(path);
        ...
        public void MockDirectory_Move_ShouldThrowAnIOExceptionIfBothPathAreIdentical()
        {
            ...
            // Act
            TestDelegate action = () => fileSystem.Internals.Directory.Move(path, path);
        ...
        public void MockDirectory_Move_ShouldThrowAnIOExceptionIfDirectoriesAreOnDifferentVolumes()
        {
            ...
            // Act
            TestDelegate action = () => fileSystem.Internals.Directory.Move(sourcePath, destPath);
        ...
        public void MockDirectory_EnumerateFiles_ShouldReturnAllFilesBelowPathWhenPatternIsWildcardAndSearchOptionIsAllDirectories()
        {
            ...
            // Act
            var result = fileSystem.Internals.Directory.EnumerateFiles(XFS.Path(@"c:\a"), "*", SearchOption.AllDirectories);
        ...
        public void MockDirectory_EnumerateFiles_ShouldFilterByExtensionBasedSearchPattern()
        {
            ...
            // Act
            var result = fileSystem.Internals.Directory.EnumerateFiles(XFS.Path(@"c:\"), "*.gif", SearchOption.AllDirectories);
        ...
        public void MockDirectory_EnumerateFileSystemEntries_ShouldReturnAllFilesBelowPathWhenPatternIsWildcardAndSearchOptionIsAllDirectories()
        {
            ...
            // Act
            var result = fileSystem.Internals.Directory.EnumerateFileSystemEntries(XFS.Path(@"c:\a"), "*", SearchOption.AllDirectories);
        ...
        public void MockDirectory_EnumerateFileSystemEntries_ShouldFilterByExtensionBasedSearchPattern()
        {
            ...
            // Act
            var result = fileSystem.Internals.Directory.EnumerateFileSystemEntries(XFS.Path(@"c:\"), "*.gif", SearchOption.AllDirectories);
        ...
        public void MockDirectory_GetAccessControl_ShouldThrowExceptionOnDirectoryNotFound()
        {
            ...
            // Act
            Assert.Throws<DirectoryNotFoundException>(() => fileSystem.Internals.Directory.GetAccessControl(XFS.Path(@"c:\foo")));
        }
        ...
        public void MockDirectory_GetAccessControl_ShouldReturnNewDirectorySecurity()
        {
            // Arrange
            var fileSystem = new MockFileSystem();
            fileSystem.Internals.Directory.CreateDirectory(XFS.Path(@"c:\foo"));

            // Act
            DirectorySecurity result = fileSystem.Internals.Directory.GetAccessControl(XFS.Path(@"c:\foo"));
